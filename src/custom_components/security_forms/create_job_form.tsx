...
export default function CreateJobForm() {
  ...
  <div className="col-span-12">
          ...
          <FormControl>
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="vip_services">Vip Services</SelectItem>
                <SelectItem value="crowd_control">Crowd Control</SelectItem>
                <SelectItem value="covert">Covert</SelectItem>
                <SelectItem value="field_support_unit">Field Support Unit</SelectItem>
                <SelectItem value="additional_services">Additional Services</SelectItem>
              </SelectContent>
            </Select>
          </FormControl>
          <FormMessage />
    ...
    />
        ...
        />
          <div className="mb-5 mt-6">
          <h3 className="text-lg font-semibold mb-2">Invoicing Contact Details</h3>
          </div>
        <FormField
          control={form.control}
          name="payment_person"
